...
# Usage example: 
# call makeMatrix and cacheinverese once they are placed in the working
# environment.
# To Call: 
# Create a matrix, p.e Variable1 is a non-singular square matrix
# >dummyVar1<-makeMatrix(Variable1)
# >dummyVar2<-cacheinverse(dummyVar1)
# >print (dummyVar2)
# any time the cacheinverse(dummyVar2) is called after the first time, 
...
# result of calculating the inverse using "solve", the "cacheinverse" function knows that
